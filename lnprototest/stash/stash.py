...
def rcvd(fieldname: Optional[str] = None, casttype: Any = str) -> Callable[[Runner, Event, Any], Any]:
...
def sent(fieldname: Optional[str] = None, casttype: Any = str) -> Callable[[Runner, Event, Any], Any]:
