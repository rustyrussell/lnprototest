...
class KeySet(object):
    ...
    def payment_basepoint(self) -> coincurve.PublicKey:
        return coincurve.PublicKey.from_secret(self.payment_base_secret.secret)

    def revocation_basepoint(self) -> coincurve.PublicKey:
        return coincurve.PublicKey.from_secret(self.revocation_base_secret.secret)

    def delayed_payment_basepoint(self) -> coincurve.PublicKey:
    ...
    def per_commit_point(self, n: int) -> coincurve.PublicKey:
