...
def test_rbf_accepter(runner: Runner, with_proposal: Any) -> None:
    ...
    test += accepter_tx_creation(input_index, False, funding_amount,
                                 local_funding_privkey, local_keyset,
                                 runner)
    ...
    test += accepter_tx_creation(input_index, True, rbf_funding_amount,
                                 local_funding_privkey, local_keyset,
                                 runner)
...
def test_rbf_opener(runner: Runner, with_proposal: Any) -> None:
    ...
    test += opener_tx_creation(input_index, False, funding_amount,
                               local_funding_privkey, local_keyset,
                               runner)
...
def test_rbf_not_valid_rbf(runner: Runner, with_proposal: Any) -> None:
    ...
    test += accepter_tx_creation(orig_input_index, False, funding_amount,
                                 local_funding_privkey, local_keyset,
                                 runner)
    ...
    test += [CreateFunding(txid_in=txid_in,
                           tx_index_in=tx_index_in,
                           sats_in=sats_in,
                           spending_privkey=spending_privkey,
                           fee=fee,
